...
/**
 * Servlet implementation class SearchNativeSpeech
 */
@WebServlet("/SearchNativeSpeech")
public class SearchNativeSpeech extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchNativeSpeech() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			List<TutorRegistrationDTO> TutorInfo=studentService.searchLanguage();
			...
			for(TutorRegistrationDTO tu:TutorInfo){
				...
				out.println("<td>"+tu.getNative_Languages()+"</td>");
