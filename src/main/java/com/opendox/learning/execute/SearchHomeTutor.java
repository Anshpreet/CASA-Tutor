...
/**
 * Servlet implementation class SearchHomeTutor
 */
@WebServlet("/SearchHomeTutor")
public class SearchHomeTutor extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchHomeTutor() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			List<TutorRegistrationDTO> TutorInfo=studentService.searchTutor();
			...
			for(TutorRegistrationDTO tu:TutorInfo){
				...
				out.println("<td>"+tu.getClassInfo()+"</td>");
				out.println("<td>"+tu.getSubject()+"</td>");
